...
const Blog = () => {
  ...
  return (
    <section className="min-h-screen pt-32 pb-20 bg-brand-gray bg-texture">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12 md:mb-16">
          <h4 className="text-brand-gold uppercase tracking-[0.3em] text-xs font-medium mb-3">
            Blog
          </h4>
          <h1 className="text-3xl md:text-5xl font-header font-light text-brand-slate">
            Ideias, projetos e inspiração
          </h1>
          ...
          {posts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h2 className="mt-2 mb-3 font-header font-medium text-xl text-brand-slate group-hover:text-brand-gold transition-colors leading-snug">
                  {post.title}
                </h2>

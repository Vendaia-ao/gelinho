...
const Home = () => {
  ...
  // Portfolio images from public folder
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground text-sm font-light leading-relaxed">
                  Projetos 3D inovadores que combinam função e beleza.
                </p>
                <Link
                  to="/servicos"
              ...
              >
                ...
                <p className="text-muted-foreground text-sm font-light leading-relaxed">
                  Design de interiores sofisticado e personalizado.
                </p>
                <Link
                  to="/servicos"
                  className="inline-block mt-4 md:mt-6 text-brand-gold text-xs uppercase tracking-widest font-medium group-hover:translate-x-2 transition-transform"
              ...
              >
                ...
                <p className="text-muted-foreground text-sm font-light leading-relaxed">
                  Obras de alta qualidade com acabamentos premium.
                </p>
                <Link
                  to="/servicos"
                  className="inline-block mt-4 md:mt-6 text-brand-gold text-xs uppercase tracking-widest font-medium group-hover:translate-x-2 transition-transform"
